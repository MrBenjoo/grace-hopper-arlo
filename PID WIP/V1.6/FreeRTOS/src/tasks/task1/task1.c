...
#define sampleTime 50 //Samplingtid för PID-regleringen i millisekunder
...
//OBS UNDVIK DOUBLE ANVÄND ISTÄLLET FLOATS
	...
	*/
	...
	while(1){
		...
		//%%%%%%%%%%    TEST         %%%%%%%%%%%
	    //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
			linearLeftDesired = 30.000; // Börvärden i cm/s ,lika stora värden om den ska köra rakt 
			linearRightDesired = 30.000;
		//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
