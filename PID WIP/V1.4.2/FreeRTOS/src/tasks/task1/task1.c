...
// OBS VÄRDET PÅ TESTS OCH STEPS DEFINIERAR STORLEKEN PÅ EN DEL ARRAYS. DÄR FINNS EN GRÄNS! TEST 84 och STEPS 28 ÄR OK
#define TESTS 84//Formula to calculate value of TESTS: (700/speedIncrementFactor)*totalTestRounds
#define STEPS 28//Formula to calculate value of STEPS: (700/speedIncrementFactor)
/*
* Function: task1
* -------------------
...
void task1(void *pvParamters)
{
	while(1){
		...
		int speedIncrementFactor = 25; //MODIFY for your test, NOTE: Motorspeed is limited to 0-100
		int step = 0;
		...
		int totalTestRounds = 4; //MODIFY the number of re-runs that all values will then be divided by to get an average
