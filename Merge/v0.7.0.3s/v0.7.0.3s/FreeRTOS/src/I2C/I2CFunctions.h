...
#define BORJA_PLOCKA                0x22					/*message to the arm that we are at the object */
#define LAMNA_OBJEKT                0x25					/* message to the arm that we are at the drop off */
#define HAMTA_ID                    0x23					/*message to the arm that we want their id */
