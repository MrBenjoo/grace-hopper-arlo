...
{	
	...
	rtos_init();
		...
		//BEHÖVS PWM PINNARNA INITLIALISERAS SOM OUTPUT ELLER GÖRS DET I PWM CONFIGURE?
		//ioport_set_pin_dir(PWM_35, IOPORT_DIR_OUTPUT); //PWM
		//ioport_set_pin_dir(PWM_42, IOPORT_DIR_OUTPUT);  //PWM
		
		//I2C pinnarna är både inputs och outputs, de behöver inte initialiseras på samma sätt
