...
/* I2C messages to exchange with pab */
#define BORJA_PLOCKA			0x22
#define LAMNA_AV_OBJEKT			0x25
#define LYCKAT_LYFT				0x14
#define MISSLYCKAT_LYFT			0x15
#define LYCKAD_AVLAMNING		0x16
#define MISSLYCKAD_AVLAMNING	0x17
#define HAMTA_ID				0x23
#define VINGLASS_ID				0x30
#define KUB_ID					0x40
/* --------------------------------- */
...
#define TWI_GENERAL_CALL_ADDRESS			0x00				/* 0 = general call address (reserved), addresses all devices on the bus */
#define TWI_PORT					TWI1				/* Use SDA 20 and SCL 21 on Arduino Due because they provide pull ups */

#define TWI_DATA_SEND_LENGTH_PAB		1					/* The length of the package that is sent to påbyggnad */
#define TWI_DATA_SEND_LENGTH_POS	1					/* The length of the package that is sent to positionering */
#define TWI_DATA_REC_LENGTH_PAB		1					/* The length of the package that is received from påbyggnad */
#define TWI_DATA_REC_LENGTH_POS		10					/* The length of the package that is received from positionering */

extern uint8_t send_data_pab[TWI_DATA_SEND_LENGTH_PAB];		/* stores the data which will be sent to påbyggnad */
extern uint8_t send_data_pos[TWI_DATA_SEND_LENGTH_POS];		/* stores the data which will be sent to positionering */
extern uint8_t rec_data_pab[TWI_DATA_REC_LENGTH_PAB];		/* stores the data which will be received from påbyggnad */
